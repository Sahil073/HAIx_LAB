...
def main():
    ...
    # Create control panel frame at top
    ...
    # Hover threshold label and dropdown
    ...
    def on_configure(event):
        # Only process canvas resize events
